...
/**
* Fachliche Tests fuer Schritt 2 (Model Execution) der CtlBignet2BoniErmittlung für Small Reports.
...
*/
public class ModelExtecutionSmallReport_Test
{
	...
	public void setup()
	{
		...
		ProduktSpezifischeConfigSettings produktSpezifischeConfigSettings = new ProduktSpezifischeConfigSettings(ReportType.SMALL);
	...
	@Test
	public void executeTF_AAA_SR_1()
	{
		// arrange
		...
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		...
		if (boniData.parameter.krediturteil != AaaKrediturteil._51
       	    && boniData.parameter.krediturteil != AaaKrediturteil._61)
		{
			// nur in diesen Fällen kann das Krediturteil hier getestet werden,
	        // weil Krediturteil 51 und 61 in Schritt 3 (der hier nicht ausgeführt werden kann) remappt wird
		...
		if (boniData.parameter.hoechstkrediturteil != AaaHoechstKrediturteil._52)
		{
			// nur in diesen Fällen kann das Hoechstkrediturteil hier getestet werden,
	        // weil Hoechstkrediturteil 52 in Schritt 3 (der hier nicht ausgeführt werden kann) remappt wird
		Assert.assertEquals("Hoechstkrediturteil", expectedHKU, boniData.parameter.hoechstkrediturteil);
		}
	}

	@Test
	public void executeTF_AAA_SR_2()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingNonAvailabilityReasonCode = RatingNonAvailibilityReasonCode.valueOf("NEW");
	...
	@Test
	public void executeTF_AAA_SR_3()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingNonAvailabilityReasonCode = RatingNonAvailibilityReasonCode.valueOf("NEW");
	...
	@Test
	public void executeTF_AAA_SR_4()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_020");
		boniData.bignetData.ratingData.creditLimitOfPartnerInEuro = new BigDecimal( "10000" );
		boniData.bignetData.historiendaten.foundationDate = new UnscharfesDatum( "2014-01-01" );
		boniData.bignetData.kapitalAngabenFuerKapitalPruefung.eingezahltesKapital = new BigDecimal( "100000" );
	...
	@Test
	public void executeTF_AAA_SR_5()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		...
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_55");
		final BigDecimal expectedHKV = null;
		final AaaHoechstKrediturteil expectedHKU = AaaHoechstKrediturteil.valueOf("_66");
	...
	@Test
	public void executeTF_AAA_SR_6()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_030");
		boniData.bignetData.ratingData.creditLimitOfPartnerInEuro = new BigDecimal( "330000" );
		boniData.bignetData.historiendaten.foundationDate = new UnscharfesDatum( "2000-01-01" );
	...
	@Test
	public void executeTF_AAA_SR_7()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("1"));
	...
	@Test
	public void executeTF_AAA_SR_8()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_9()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_010");
	...
	@Test
	public void executeTF_AAA_SR_10()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_080");
	...
	@Test
	public void executeTF_AAA_SR_11()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_12()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_040");
		boniData.bignetData.ratingData.creditRiskCode = CreditRiscCode.valueOf("_004");
	...
	@Test
	public void executeTF_AAA_SR_13()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
		...
		// assert
		final Integer expectedBix = new Integer(372) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_22");
	...
	@Test
	public void executeTF_AAA_SR_14()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
	...
	@Test
	public void executeTF_AAA_SR_15()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_16()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("2"));
		...
		// assert
		final Integer expectedBix = new Integer(428) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
	...
	@Test
	public void executeTF_AAA_SR_17()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("1"));
	...
	@Test
	public void executeTF_AAA_SR_18()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
	...
	@Test
	public void executeTF_AAA_SR_19()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
	...
	@Test
	public void executeTF_AAA_SR_20()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("2"));
	...
	@Test
	public void executeTF_AAA_SR_21()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("2"));
	...
	@Test
	public void executeTF_AAA_SR_22()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
	...
	@Test
	public void executeTF_AAA_SR_23()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_24()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_25()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("2"));
	...
	@Test
	public void executeTF_AAA_SR_26()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
		...
		// assert
		final Integer expectedBix = new Integer(398) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_22");
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_41");
		final BigDecimal expectedHKV = null;
	...
	@Test
	public void executeTF_AAA_SR_27()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_28()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
		...
		// assert
		final Integer expectedBix = new Integer(239) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_22");
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_21");
		final BigDecimal expectedHKV = new BigDecimal( "150000" );
	...
	@Test
	public void executeTF_AAA_SR_29()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
	...
	@Test
	public void executeTF_AAA_SR_30()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_31()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_32()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
		...
		// assert
		final Integer expectedBix = new Integer(205) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_29");
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_21");
		final BigDecimal expectedHKV = new BigDecimal( "1000" );
	...
	@Test
	public void executeTF_AAA_SR_33()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_34()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_35()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
		...
		boniData.bignetData.historiendaten.foundationDate = new UnscharfesDatum( "2000-01-01" );
		boniData.bignetData.kapitalAngabenFuerKapitalPruefung.umlaufvermoegen = new BigDecimal( "103329199" );
		boniData.bignetData.kapitalAngabenFuerKapitalPruefung.kurzfristigeVerbindlichkeiten = new BigDecimal( "-34277082" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.umlaufvermoegen = new BigDecimal( "103329199" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.kurzfristigeVerbindlichkeiten = new BigDecimal( "-34277082" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.gezeichnetesKapital = new BigDecimal( "21814631" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.jahresumsatz = new BigDecimal( "-187222834" );
	...
	@Test
	public void executeTF_AAA_SR_36()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_37()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_38()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_39()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_41()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
		...
		// assert
		final Integer expectedBix = new Integer(199) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_29");
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_21");
		final BigDecimal expectedHKV = new BigDecimal( "1000" );
	...
	@Test
	public void executeTF_AAA_SR_42()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_43()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
	...
	@Test
	public void executeTF_AAA_SR_44()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingNonAvailabilityReasonCode = RatingNonAvailibilityReasonCode.valueOf("NEW");
		...
		boniData.bignetData.ratingData.creditRiskCode = CreditRiscCode.valueOf("_001");
		boniData.bignetData.ratingData.creditLimitOfPartnerInEuro = new BigDecimal( "10000" );
		boniData.bignetData.historiendaten.foundationDate = new UnscharfesDatum( "" );
		boniData.bignetData.historiendaten.firstRegistrationDate = new UnscharfesDatum( "2013-12-02" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.jahresumsatz = new BigDecimal( "1250000" );
	...
	@Test
	public void executeTF_AAA_SR_45()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingNonAvailabilityReasonCode = RatingNonAvailibilityReasonCode.valueOf("NEW");
	...
	@Test
	public void executeTF_AAA_SR_46()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_47()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("1"));
	...
	@Test
	public void executeTF_AAA_SR_48()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_49()
	{
		// arrange
	...
	@Test
	public void executeTF_AAA_SR_50()
	{
		// arrange
	...
	@Test
	public void executeTF_AAA_SR_53()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
		...
		// assert
		final Integer expectedBix = new Integer(313) ;
		// Hinweis: Die BoniKlasse wird erst in Schritt 3 gesetzt und kann hier im Schritt 2 nicht getestet werden!
		final AaaZahlungsweise expectedZW = AaaZahlungsweise.valueOf("_22");
		final AaaKrediturteil expectedKU = AaaKrediturteil.valueOf("_31");
	...
	@Test
	public void executeTF_AAA_SR_55()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_56()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_57()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_58()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("4"));
	...
	@Test
	public void executeTF_AAA_SR_59()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-06-24" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("5"));
	...
	@Test
	public void executeTF_AAA_SR_60()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
		...
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.kurzfristigeVerbindlichkeiten = new BigDecimal( "100000" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.eigenkapital = new BigDecimal( "-1000" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.eingezahltesKapital = new BigDecimal( "21814630" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.gezeichnetesKapital = new BigDecimal( "21814630" );
		boniData.bignetData.kapitalAngabenFuerHoechstkreditBerechnung.jahresumsatz = new BigDecimal( "16547.95" );
	...
	@Test
	public void executeTF_AAA_SR_61()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.paymentBehaviourCode = PaymentBehaviourCode.valueOf("_010");
	...
	@Test
	public void executeTF_AAA_SR_62()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
	...
	@Test
	public void executeTF_AAA_SR_63()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-07-07" );
		boniData.bignetData.ratingData.ratingNonAvailabilityReasonCode = RatingNonAvailibilityReasonCode.valueOf("PAR");
	...
	@Test
	public void executeTF_AAA_SR_64()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-06-24" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_65()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-06-24" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
	...
	@Test
	public void executeTF_AAA_SR_66()
	{
		// arrange
		boniData.bignetData.abrufZeitpunkt = DateUtil.toDateTime( "2014-06-24" );
		boniData.bignetData.ratingData.ratingCode = boniData.config.toRatingCode(RatingClassCode.getEnum("3"));
