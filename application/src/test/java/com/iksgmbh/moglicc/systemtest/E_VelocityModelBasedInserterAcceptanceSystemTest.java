...
public class E_VelocityModelBasedInserterAcceptanceSystemTest extends __AbstractSystemTest {
	...
	public void createsOutputFilesWithASCIIEncodingReadFromMainTemplate() throws Exception {
		final File templateFile = prepareArtefactDirectory("main.tpl", INSERTER_PLUGIN_ID, "myNewArtefact");
