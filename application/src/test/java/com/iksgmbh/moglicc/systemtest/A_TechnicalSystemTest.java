...
public class A_TechnicalSystemTest extends __AbstractSystemTest {
	...
	public void createsNewWorkspaceDirWithRelativePathToSubdir() {
		...
		assertChildrenNumberInDirectory(workspaceOutputDir, getNumberOfPlugins() - 3); // -1 due to EngineProvider and ExcelStandardModelProvider having no output dir and -1 for LineInserter having no template for current model 
