...
public class MetaInfoValidationUtil {
	...
	public static MetaInfoValidatorParent parseValidatorLine(String line) throws MOGLiPluginException {
	...
	public static MetaInfoValidationCondition parseConditionLine(String line) throws MOGLiPluginException {
		line = line.trim();
