...
import static com.iksgmbh.moglicc.MOGLiTextConstants2.TEXT_PLUGIN_EXECUTED;
...
import com.iksgmbh.moglicc.infrastructure.MOGLiLogger2;
...
public class PluginExecutorUnitTest extends CoreTestParent {
	...
	public void testExecutePlugins_1PluginExecutedSuccessfully() {
		...
		File pluginLogfile = MOGLiFileUtil2.getNewFileInstance(DIR_LOGS_FILES 
		...
		MOGLiLogger2 logger = (MOGLiLogger2) 
	...
	public void testExecutePlugins_1PluginExecutedException() {
		...
		File pluginLogfile = MOGLiFileUtil2.getNewFileInstance(DIR_LOGS_FILES + "/DummyPlugin.log");
		pluginLogfile.delete();
		assertFalse("Logfile not deleted", pluginLogfile.exists());
		...
		MOGLiLogger2 logger = (MOGLiLogger2) pluginExecutor.getInfrastructureFor(dummyPlugin.getId()).getPluginLogger();
	...
	public void testExecutePlugins_1PluginExecutedRuntimeException() {
		...
		MOGLiLogger2 logger = (MOGLiLogger2) pluginExecutor.getInfrastructureFor(
	...
	public void testExecutePlugins_2PluginExecutedSuccessfully() {
		...
		final MOGLiLogger2 logger = (MOGLiLogger2) pluginExecutor.getInfrastructureFor(
	...
	public void testExecutePlugins_3PluginExecutedSuccessfully() {
		...
		// verify test result
		assertAllPluginsExecutedSuccessfullyExcept(-1);
		MOGLiLogger2 logger = (MOGLiLogger2) pluginExecutor.getInfrastructureFor(dataProvider.getId()).getPluginLogger();
	...
	public void testExecutePlugins_4PluginExecutedSuccessfully() {
		...
		// verify test result
		assertAllPluginsExecutedSuccessfullyExcept(-1);
		MOGLiLogger2 logger = (MOGLiLogger2) pluginExecutor.getInfrastructureFor(engineProvider.getId()).getPluginLogger();
