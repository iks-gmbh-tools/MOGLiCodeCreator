...
/**
* Raw draft of the starter class of the MyDataProvider plugin.
* TODO: Complete the implementation manually.
* @author generated by MOGLi Code Creator
*/
public class NewDataProviderStarter implements DataProvider {

	public static final String PLUGIN_ID = "MyDataProvider";
	...
	public PluginType getPluginType() {
		return PluginType.DATA_PROVIDER;
	}
